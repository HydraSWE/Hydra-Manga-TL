...
class ManualRegion:
    ...
    def __post_init__(self) -> None:
        ...
        self.polygon = (
            [[int(point[0]), int(point[1])] for point in self.polygon]
            if self.polygon else _rect_to_polygon(self.rect)
        )
...
class MangaProject:
    ...
    def load(cls, path: Path) -> "MangaProject":
        ...
        return cls(
            ...
            filmstrip_visible=bool(payload.get("filmstrip_visible", True)), images=images,
